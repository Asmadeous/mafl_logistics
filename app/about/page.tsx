...
export default function AboutPage() {
  ...
  const faqs = [
    ...
    {
      question:
        "Does MAFL handle customs clearance for cross-border shipments?",
      answer:
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="py-20 bg-white dark:bg-navy">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 md:grid-cols-2 items-center">
            ...
            >
              <Image
                src="/kenyan-logistics-team.jpg"
                alt="About MAFL Logistics"
                fill
            ...
            >
              <div>
                ...
                <h2 className="text-4xl font-bold tracking-tight mb-6 text-navy dark:text-white">
                  About Our Company
                </h2>
              </div>
              <p className="text-lg text-navy dark:text-gray-300 leading-relaxed">
                MAFL Logistics specializes in providing efficient & reliable
                transportation solutions across Kenya. Founded by Mahdi M.
                Issack, we focus on heavy machinery transport, warehousing &
                storage, containerized & bulk cargo, & hauling services.
              </p>
              <p className="text-lg text-navy dark:text-gray-300 leading-relaxed">
                With a dedicated fleet, we ensure safe, timely, & hassle-free
                deliveries for industrial equipment, construction materials, &
                bulk shipments. Our commitment to excellence has made us a
                trusted partner for businesses across East Africa.
              </p>
              <div className="grid grid-cols-2 gap-6 mt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-navy/70 dark:text-gray-400">
                      Consistent service
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-lg text-navy/80 dark:text-gray-300">
              From humble beginnings to becoming a leading logistics provider in
              East Africa
            </p>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:pr-12">
                  ...
                  <p className="text-navy dark:text-white leading-relaxed">
                    Founded in 2021, MAFL Logistics started with local freight
                    operations, focusing on delivering reliable & efficient
                    logistics solutions across Kenya. The early days were marked
                    by determination and a commitment to excellence, laying the
                    foundation for what would become one of the region's most
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="md:text-left md:pl-12 md:order-2 order-1">
                  ...
                  <p className="text-navy dark:text-white leading-relaxed">
                    Through investment in technology & strong partnerships, we
                    expanded into regional & cross-border logistics, serving
                    Kenya, Rwanda, & Ethiopia. This period marked significant
                    growth in our fleet size and service capabilities,
                    establishing key partnerships with major clients and
                    government entities.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:pr-12">
                  ...
                  <p className="text-navy dark:text-white leading-relaxed">
                    MAFL Logistics continues to grow by specializing in heavy
                    machinery transport, warehousing, & bulk cargo handling
                    while innovating to meet future logistics needs. Today,
                    we're recognized as a leader in specialized logistics
                    solutions across East Africa, with a reputation for
      ...
      <section
        ref={valuesRef}
        className="py-20 bg-white dark:bg-navy text-navy dark:text-white"
      >
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            className="text-center mb-16"
          ...
          >
            ...
            <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
            <p className="max-w-3xl mx-auto text-lg text-navy/80 dark:text-gray-300">
              We prioritize integrity, professionalism, & customer-focused
              service in every delivery
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "We deliver on our promises, ensuring timely and consistent service.",
              },
              {
                title: "Excellence",
                icon: <Building className="h-10 w-10 text-primary mb-4" />,
                description:
                  "We strive for the highest standards in all aspects of our operations.",
              },
              {
                title: "Innovation",
              ...
              },
              {
                ...
                description:
                  "We maintain the highest safety standards for our team, cargo, and environment.",
              },
            ].map((value, index) => (
              <motion.div
                key={value.title}
      ...
      <section ref={ceoRef} className="py-20 bg-gray-50 dark:bg-navy/90">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 md:grid-cols-2 items-center">
            ...
            >
              ...
              <div className="bg-white dark:bg-navy/50 p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <p className="text-xl text-navy dark:text-gray-300 italic leading-relaxed mb-6">
                  "At MAFL Logistics, we go beyond moving goods, we deliver
                  trust, precision, & value. Committed to timely & secure
                  deliveries, we continue to invest in technology, expand our
                  fleet, & build strong partnerships. From heavy machinery
                  transport to warehousing & bulk cargo handling, we are your
                  reliable logistics partner."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                    <Image
                      src="/ceo-mahdi-issack.jpg"
                      alt="CEO"
                      width={48}
                      height={48}
                      className="object-cover"
                  ...
                  <div>
                    ...
                    <p className="text-navy/70 dark:text-gray-400 text-sm">
                      CEO & Founder
                    </p>
                  </div>
                </div>
            ...
            <motion.div
              className="relative h-[450px] order-1 md:order-2 rounded-xl overflow-hidden shadow-xl"
              initial={{ opacity: 0, x: 50 }}
              animate={ceoInView ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.6 }}
            >
  ...
  <div className="container mx-auto px-4 md:px-6">
    <div className="grid gap-12 md:grid-cols-2 items-start">
      ...
      >
        ...
        <div className="bg-white dark:bg-navy/50 p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <p className="text-xl text-navy dark:text-gray-300 italic leading-relaxed mb-6">
            "At MAFL Logistics, we go beyond moving goods, we deliver trust, precision, & value. Committed to timely & secure deliveries, we continue to invest in technology, expand our fleet, & build strong partnerships. From heavy machinery transport to warehousing & bulk cargo handling, we are your reliable logistics partner."
          </p>
          <div className="flex items-center">
            <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
              <Image
      ...
      {/* Image Block */}
      <motion.div
        className="relative w-full h-full order-1 md:order-2 rounded-xl overflow-hidden shadow-xl flex"
        initial={{ opacity: 0, x: 50 }}
        animate={ceoInView ? { opacity: 1, x: 0 } : {}}
        transition={{ duration: 0.6 }}
      >
                ...
                <div className="relative h-[300px] overflow-hidden rounded-xl shadow-lg mb-6">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform">
                    <p className="text-sm opacity-80">
                      Dedicated to excellence in logistics and transportation
