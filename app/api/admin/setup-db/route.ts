...
export async function POST(request: Request) {
  try {
    ...
    await supabase.query(`ALTER TABLE public.user_notifications ENABLE ROW LEVEL SECURITY;`)
    await supabase.query(`ALTER TABLE public.user_messages ENABLE ROW LEVEL SECURITY;`)
    await supabase.query(`ALTER TABLE public.user_status ENABLE ROW LEVEL SECURITY;`)
