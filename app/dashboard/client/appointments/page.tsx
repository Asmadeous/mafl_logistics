...
export default function ClientAppointmentsPage() {
  ...
  const { playSound, handleSoundEnded } = useAppointmentNotifications(appointments || [], "client")
  ...
  const handleCreateAppointment = async (data: any) => {
    try {
      ...
      toast({
        ...
        description: "Your company appointment has been successfully scheduled.",
      })
    } catch (error) {
      toast({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h1 className="text-2xl font-bold tracking-tight">Company Appointments</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your company's scheduled appointments</CardDescription>
        </CardHeader>
        <CardContent>
